        ...
        <div class="main-menu">
            ...
            <div class="logo-box">
                ...
                <a href="index.html" class="logo-light">
                    <img src="{{asset('/')}}assets/backend/images/logo-light.png" alt="logo" class="logo-lg"
                        height="22">
                    <img src="{{asset('/')}}assets/backend/images/logo-sm.png" alt="small logo" class="logo-sm"
                        height="22">
                </a>

                <!-- Brand Logo Dark -->
                <a href="index.html" class="logo-dark">
                    <img src="{{asset('/')}}assets/backend/images/logo-dark.png" alt="dark logo" class="logo-lg"
                        height="22">
                    <img src="{{asset('/')}}assets/backend/images/logo-sm.png" alt="small logo" class="logo-sm"
                        height="22">
                </a>
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-4">
                        ...
                        {{-- <li class="dropdown d-none d-md-inline-block">
                            <a class="nav-link dropdown-toggle waves-effect waves-light arrow-none"
                                data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                aria-expanded="false">
                                <img src="{{asset('/')}}assets/backend/images/flags/us.jpg" alt="user-image"
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{asset('/')}}assets/backend/images/flags/italy.jpg" alt="user-image"
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{asset('/')}}assets/backend/images/flags/spain.jpg" alt="user-image"
                                        class="me-1" height="12">
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{asset('/')}}assets/backend/images/flags/russia.jpg" alt="user-image"
                                        class="me-1" height="12">
